...
import styles from "./welcome-item.module.css";
...
export default function WelcomeItem() {
  ...
  return show?.status === "disabled" ? null : (
    <motion.div
      className="box"
      animate={
        show
          ...
          <div className={styles.wrapper}>
            <Stack className={styles.stack}>
              ...
              <Typography variant="body2" className={styles.body2}>
                Рады тебя видеть в нашем сервисе! Перед началом работы добавь
                новый API-ключ во вкладке «Ключи» на странице аккаунта. Также,
                для понятия устройства сервиса, рекомендуем тебе почитать наш
                FAQ
              </Typography>
            ...
            <span className={styles.svg_span}>
              ...
              >
                ...
                <image href="/images/woman_3.png" height="300" x="312" y="30" />
              </svg>
            </span>
          </div>
        </Grid>
